...
<div class="content" style="margin-top:2%">
	...
	<table class="endpoint_table" style="margin-left:90px" cellpadding="0" cellspacing="0" border="0"  width="50%">
		...
		<tr>
			...
			<td width="20%" align="left" valign="top" style="word-wrap:break-word;white-space:wrap;"><?php if(isset($paramvalue->Required) && $paramvalue->Required == '1') echo '<b>Required</b>&nbsp;&nbsp;' ;  if(isset($paramvalue->Explanation) && $paramvalue->Explanation != '') echo  $paramvalue->Explanation ; else if($paramvalue->Required == '0') echo '-';   ?></td>
		</tr>
		<?php } ?>
	</table>
