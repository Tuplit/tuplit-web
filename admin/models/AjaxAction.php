...
if(isset($_GET['action']) && $_GET['action'] == 'TRANSACTION_LIST'){
	...
	if(isset($_GET['searchType']) && $_GET['searchType'] == 1){
		...
		$fields    				= " o1.OrderStatus,o1.TotalPrice,o1.TransactionId,o1.TotalItems,o1.OrderDate,o1.Status,o1.fkCartId,u.FirstName,u.LastName,u.Photo,m.CompanyName,m.Icon,o1.fkUsersId,o1.fkMerchantsId,o1.Commision";
...
if(isset($_POST['action']) && $_POST['action']!='' && $_POST['action']=="GET_CHART_DATA" && $_POST['cond']!=''){
		$cond .=$_POST['cond'];
		echo $cond;
}
?>
