...
<?php top_header(); ?>
	...
	<section class="content-header">
		<div class="row col-xs-10">
			<h1><i class="fa fa-list"></i> Transaction Analytics </h1>			
		</div>
	</section>
	<!-- Main content -->
			...
			<div class="box box-success">
				<div class="product_list">
					<div class="dashboard_filter order_filter">
						<form name="dashboard_list_search" id="dashboard_list_search" action="" method="POST" >
					...
					<section class="content">
						<div class="row">
							<div class="col-xs-12">
								<form name="trans_search" id="trans_search" action="TransactionAnalytics?cs=1" method="POST" >
