				 	...
				 	<div class="box box-primary box-padding report">
						<div class="box-body no-padding">				
							<div class="col-sm-4 form-group">
								<!--<label>Module</label>-->
								<input type="text" class="form-control" name="search_module" id="search_module" placeholder="Module" value="<?php  if(isset($_SESSION['tuplit_sess_search_module']) && $_SESSION['tuplit_sess_search_module'] != '') echo unEscapeSpecialCharacters($_SESSION['tuplit_sess_search_module']);  ?>"  >
							</div>
							<div class="col-sm-4 form-group">
								<!--<label>Purpose</label>-->
								<input type="text" class="form-control" id="search_process" name="search_process" placeholder="Purpose" value="<?php  if(isset($_SESSION['tuplit_sess_search_process']) && $_SESSION['tuplit_sess_search_process'] != '') echo unEscapeSpecialCharacters($_SESSION['tuplit_sess_search_process']);  ?>" >
							</div>
			...
			<?php require_once('StatisticsTabs.php');?>
				  <div class="row paging-margin paging">
					<div class="col-xs-12 col-sm-2 no-padding">
						...
						<div class="dataTables_info "><span class="white_txt">No. of Service(s)&nbsp;:&nbsp;<strong><?php echo $tot_rec; ?></strong></span> </div>
						<?php } ?>
					</div>
		                           ...
		                           <table class="table table-hover" id="myTable">
		                               <tr>
											...
											<th width="3%"><?php echo SortColumn('Ordering','Order'); ?></th>													
											 <th  width="6%" colspan="2" align="center">Action</th>			
										</tr>
										...
										<tr>												
											...
											<td align="center"><input type="Text" style="text-align: center" class="form-control" name="ordering" id="ordering" value="<?php if(isset($value->Ordering) && $value->Ordering != '' ) echo $value->Ordering; ?>" class="order" maxlength="5" onkeypress="return isNumberKey(event);" onchange="setOrderingWebService(this.value,<?php if(isset($value->id) && $value->id != '') echo $value->id; ?>);" ></td>
