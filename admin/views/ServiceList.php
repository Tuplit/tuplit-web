						...
						<td colspan="2">
						 	 <div id="content_3" class="content">							 
							   	 <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" class="headertable">
									 <tr><td><span><h2>Service List</h2></span></td><td align="right"><span><a style="cursor:pointer;" href="ServiceManage" title="Add Services"> + Add Services</a></span></td></tr>
					                    ...
					                    <td valign="top" align="center" colspan="2">
											 <form name="search_service" action="ServiceList" method="post">
					                           <table align="center" cellpadding="0" cellspacing="0" border="0" class="filter_form" width="100%">										       
													...
													<tr><td align="center"><table cellpadding="0" cellspacing="0" align="center" width="75%" border="0">
													<tr>
														<td align="left"  width="10%" ><label>Module</label></td>
														<td width="2%"  >:</td>
														<td align="left" height="40" width="20%">
															<input type="text" class="input" name="search_module" id="search_module"  value="<?php  if(isset($_SESSION['tuplit_sess_search_module']) && $_SESSION['tuplit_sess_search_module'] != '') echo unEscapeSpecialCharacters($_SESSION['tuplit_sess_search_module']);  ?>" >
														</td>	
														<td align="left"  width="20%" style="padding-left:10%;" ><label>Purpose</label></td>
														<td width="3%" >:</td>
														<td align="left" width="20%">
															<input type="text" class="input" name="search_process" id="search_process"  value="<?php  if(isset($_SESSION['tuplit_sess_search_process']) && $_SESSION['tuplit_sess_search_process'] != '') echo unEscapeSpecialCharacters($_SESSION['tuplit_sess_search_process']);  ?>" >
														</td>		
														<td align="center" colspan="3"><input type="submit" class="submit" name="Search" id="Search" value="Search" title="Search" alt="Search"></td>											
													</tr>
													</td></tr></table>
													<tr><td height="15"></td></tr>
									...
									<tr>
										<td colspan="2" align="center">
										   <?php if(isset($serviceResult) && is_array($serviceResult) && count($serviceResult) > 0 ) { ?>
											...
											<?php } else { ?>	
											<div class="error_msg" align="center">No Service found </div>
											<?php } ?>	
										</td>
									</tr>
								</table>							 
