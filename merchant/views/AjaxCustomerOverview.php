...
if($_SERVER['REMOTE_ADDR'] == '172.21.4.113'){
	//echo "==============url====>". $url;
	//echo "<pre>";print_r($CustomerOverview);echo "</pre>";
					...
					<div class="today_btn col-xs-12 col-sm-2 col-md-2 col-lg-2 no-padding text-right LH56 ">
						<div class="btn-group">
							<button class="btn btn-default btn-sm dropdown-toggle" value="" type="button" data-toggle="dropdown">
								<span id="dateTypes"><?php if(isset($_GET['DataType']) && !empty($_GET['DataType'])) echo $_GET['DataType']; else echo "Today";?></span><span class="caret"></span>
							</button>
					...
					<div class="box box-primary no-padding">
						<div class="row box-body box-border" style="padding-bottom:0px;">
							<div class="col-xs-12 col-sm-12  col-lg-12  box-center" >
								<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center" style="padding-bottom:20px;">
									...
									<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 no-padding">
										<?php  if(isset($NewCust_Visits) && !empty($NewCust_Visits)){ ?>
											<div class="LH185">
												...
												<!--<canvas id="myCanvas_1" class="new_canvas" width="210" height="210"></canvas>-->
											</div>
										...
										<?php } else{ ?>
											<div align="center" class="alert alert-danger alert-dismissable col-lg-11 col-sm-11 col-xs-11">
												No result found
											</div>
										<?php } ?>
									</div>
									<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 no-padding">
										<?php  if(isset($RepeatCust_Visits) && !empty($RepeatCust_Visits)){ ?>
											<div class="LH185">
												...
												<!--<canvas id="myCanvas_2" class="return_canvas" width="210" height="210"></canvas>-->
											</div>
							...
							<div class="box-body table-responsive no-padding no-margin">
								<table class="table table-hover customer_list cust_analy_overview">
									...
									<tr class="LTstdmedium">	
										<td><?php echo (!empty($value['RepeatCustomers']['Date'])?$value['RepeatCustomers']['Date']:$value['NewCustomers']['Date']); ?></td>
...
<?php commonFooter(); ?>
<?php } ?>
<script src="<?php echo MERCHANT_SCRIPT_PATH; ?>theme/plugins/morris/raphel.min.js"></script>
<!--<script src="//cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>-->
<script type="text/javascript">
	$(document).ready(function(){
		 //circleChart(text1,text2,radius,color,canvasId,type);
		<?php  if(isset($NewCust_Visits) && !empty($NewCust_Visits)){ ?>
