			...
			<div class="col-md-12"> 
				<div class="box box-primary"> 
					...
					<div class="form-group col-md-6">
						...
						<label class="col-xs-2 no-padding"><input type="Radio" id="DiscountApplied" value="1" onchange="return calculateDiscountPrice();" name="DiscountApplied" <?php if(isset($DiscountApplied) && ($DiscountApplied == '1' || $DiscountApplied == '')) echo 'checked';?> > &nbsp;&nbsp;Yes</label>&nbsp;&nbsp;&nbsp;&nbsp;
						<label class="col-xs-2 no-padding"><input type="Radio" id="DiscountApplied" value="0" onchange="return calculateDiscountPrice();" name="DiscountApplied" <?php if(isset($DiscountApplied) && $DiscountApplied == '0') echo 'checked';?> > &nbsp;&nbsp;No</label>
					</div>
					<div class="form-group col-md-6">
						<?php
						if($Discount > 0)
					...
					<div class="form-group col-md-6 " style="clear : none;">
						...
						<div class="radio ">
							<label class="col-xs-2 no-padding"><input type="Radio" value="1"  class=""  id="Status"  name="Status" <?php if(isset($Status) && ($Status == '1' || $Status == '' )) echo 'checked';?> > &nbsp;&nbsp;Active</label>&nbsp;&nbsp;&nbsp;&nbsp;
							<label class="col-xs-2 no-padding"><input type="Radio" value="2" id="Status" name="Status" <?php if(isset($Status) && $Status == '2') echo 'checked';?> > &nbsp;&nbsp;Inactive</label>
						</div>
					</div>
