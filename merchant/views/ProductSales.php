									...
									<div class="col-xs-12 text-right no-padding  ">  -->
										<div class="btn-group">
										  <button class="btn btn-default btn-sm dropdown-toggle" value="" type="button" data-toggle="dropdown">
											...
											<ul role="menu" class="dropdown-menu">
												  <li><a id="day" onclick="getAnalytics(this.id,1,1);" href="#">Today</a></li>
												  <li><a id="7days" onclick="getAnalytics(this.id,1,1);" href="#">7 days</a></li>
												  <li><a id="month" onclick="getAnalytics(this.id,1,1);" href="#">Month</a></li>
												  <li><a id="year" onclick="getAnalytics(this.id,1,1);" href="#">Year</a></li>
										   	</ul>
										</div>
								<!--	</div>
								</div> -->
