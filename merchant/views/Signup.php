		...
		<div class="form-box" id="login-box">
			<form action="" name="add_merchant_form_new" id="add_merchant_form_new"  method="post">
				<div class="body">
					...
					<div class="form-group">
						<input class="form-control" type="text" maxlength="15" name="MobileNumber"  id="MobileNumber" onkeypress="return isNumberKey(event);"  placeholder="Mobile Number" value="<?php if(isset($PhoneNumber) && !empty($PhoneNumber)) echo $PhoneNumber; ?>" required>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<input class="form-control" type="text" onkeypress="return isNumberKey(event);" name="CompanyNumber"  id="CompanyNumber"  placeholder="Registered Company Number" value="<?php if(isset($RegisterCompanyNumber) && !empty($RegisterCompanyNumber)) echo $RegisterCompanyNumber; ?>" required  >
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<select class="form-control" name="Country" id="Country" />
							...
							<?php if(isset($countries) && !empty($countries) && count($countries)>0) { foreach($countries as $code){ ?>
								<option value="<?php echo $code['id']; ?>" <?php if(isset($Currency) && $Currency == $code['id']) echo "selected"; ?>><?php echo ucfirst($code['Location']); ?></option>
							<?php } }?>
						</select>
					</div>	
