(function() {
  ...
  Morris.Grid = (function(_super) {
    ...
    Grid.prototype.gridDefaults = {
      ...
      gridIntegers: false, // y axis integer value
	  hideHover: false,
      yLabelFormat: null,
      xLabelAngle: 0,
      numLines: 5,
    ...
    Grid.prototype.setData = function(data, redraw) {
      ...
      if (((_ref = this.options.axes) === true || _ref === 'both' || _ref === 'y') || this.options.grid === true) {
        if (this.options.ymax === this.gridDefaults.ymax && this.options.ymin === this.gridDefaults.ymin) {
          ...
          if (this.options.gridIntegers) { // y axis integer value
  ...
  Morris.PieSegment = (function(_super) {
    ...
    PieSegment.prototype.render = function() {
 	...
 	this.segment = this.paper.path(path).attr({
	  ...
	  /* changed to display % - demographics chart */
      return this.value = this.paper.text(this.cx + (this.r + this.distanceFromEdge) * Math.cos(-this.labelAngle * this.rad), this.cy + (this.r + this.distanceFromEdge) * Math.sin(-this.labelAngle * this.rad) + 14, this.labelAndValue.formatter).attr({
        fill: this.color,
        stroke: "none",
        opacity: 1,
        "font-size": 12
