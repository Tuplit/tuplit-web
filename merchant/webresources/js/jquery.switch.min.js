(function (a, b) {
    ...
    var g = {
        build: function (b, c) {
            ...
            l.addClass(b.val() === j.on ? "Active" : "Inactive");
            if (i) {
                l.addClass("disabled")
            }
            var m = l.find(".ui-switch-master"),
                n = l.find(".ui-switch-handle");
            l.insertAfter(b);
            ...
            l.bind("mousedown touchstart", function (a) {
                ...
                var d = parseInt(m.css("left")),
                    e = l.data("offset").left + d,
                    f = e - b;
                l.data("modifier", f)
            });
            ...
            l.bind("mousemove touchmove", function (a) {
                ...
                if (!i && (a.type === "touchmove" || d)) {
                    ...
                    var e = l.data("offset"),
                        f = l.data("dimensions"),
                        g = l.data("center");
                    var h = b + l.data("modifier"),
                        j = e.left - (p + 35);
                    if (h > j + 18 && h <= j - 19 + f.width) {
                        m.offset({
                            left: h
                        })
                    }
            ...
            l.bind("switch:slideon", function () {
                ...
                m.stop().animate({
					...
					//custom code for calculating discount
					//alert('on');
					var price = $('#Price').val();					
